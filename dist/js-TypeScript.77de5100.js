...
function redirecione1(usuario1) {
  if (usuario1.cargo) {//atraves dessa validação e possivel verificar se esse usuario possui IAdmin ou nâo
...
function redirecione(usuario) {
  if ('cargo' in usuario) {//atraves dessa validação e possivel verificar se esse usuario possui IAdmin ou nâo
    // Se Sim vai para Area de Administração 
  } // Caso não, vai para area normal de usuario 
...
adicionaApendiceALista([1, 2, 3], 4); // Exemplo Tratando Tags input

var input = document.getElementById('input');
input.addEventListener('input', function (event) {
  var i = event.currentTarget;
  console.log("Voce digitou ".concat(i.value));
}); // Exemplo 01

function soma(a, b) {
  return console.log("Soma ".concat(a + b, " "));
}
...
//# sourceMappingURL=/js-TypeScript.77de5100.js.map